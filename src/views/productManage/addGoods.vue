    ...
    <div class="content">
      <el-form ref="form" :model="form" label-width="120px">
        ...
        <!--<el-form-item label="商品详情图">-->
          <!--<el-upload class="upload-demo" :action="'http://up-z2.qiniup.com/'" :before-upload="beforeAvatarUpload" :on-remove="handleRemove2" :on-preview="handlePreview" :on-success="handleSuccess2" :data="{token: form.qiniuyunToken}" name="file" :limit="20" list-type="picture" :file-list="fileList2">-->
            <!--<el-button size="small" type="primary">点击上传</el-button>-->
          <!--</el-upload>-->
        <!--</el-form-item>-->
        <el-form-item label="商品详情图">
